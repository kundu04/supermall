<?php 
   include("fw-config.php");
    if(isset($_POST['email']))
    {
		...
		$whereValue["admin_id"] = $data[0]['admin_id'];

	    $url = '<a href="localhost/supermall/secure/resetpassword.php?token='.$access_token.'"> Reset now</a>';
        $mailDetails['body'] = "Hello, ".$data[0]['name']."<br><br>You have requested to reset your password.<br><br>You can reset your password by clicking the link within 20 minutes... ".$url;
