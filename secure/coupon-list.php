        ...
        <div class="col-sm-12">
			...
			<div class="">
				<table  class="table table-bordered table-striped" id="datatable">
					...
					foreach ($queryResult AS $couponName);
						...
						echo '
							<div class="alert alert-success alert-block fade in">
								<button type="button" class="close close-sm" data-dismiss="alert">
									<i class="fa fa-times"></i></button>You have successfully Deleted the coupon: <strong>'.$couponName['title'].' </strong>
							</div> 
							';
						}
					}
					...
					<tr class="gradeX">
						...
						<td>'.$eachRow['uses_total'].'</td>
						<td>'.$eachRow['exp_date'].'</td>
						<td>'.$status.'</td>
						<td>
							<a title="Edit" class="btn btn-info btn-xs" href="coupon-edit.php?cid='.$eachRow['coupon_id'].'"><i class="fa fa-pencil-square-o"></i></a>
							<a title="Delete" onclick="return conf()" class="btn btn-danger btn-xs" href="?del='.$eachRow['coupon_id'].'"><i class="fa fa-trash-o"></i></a>
						</td>
					</tr>';
					}				
					?>
